        ...
        <table class="table table-dark table-hover">
            ...
            <tbody>
                <tr v-for = "record in records" :key = "record.record.id">
                    ...
                    <td>{{ record.result }}</td>
                    <td>{{ record.record.timeCreated }}</td>
                    <td>
                        <button @click = "open_playback(record.record.id)" type="button" class="btn btn-primary">
                            Playback
                        </button>
                    </td>
                </tr>
...
export default{
    setup(){
        ...
        const click_page = page =>{
            ...
            let max_pages = parseInt((total_records + 9) / 10);
